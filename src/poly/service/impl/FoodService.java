...
public class FoodService implements IFoodService {
   ...
   public int getFoodInfoFromWEB() throws Exception {
      ...
      Iterator<Element> food_day=element.select("tbody tr td:nth-child(1)").iterator();
      ...
      while(i<5) {
         ...
         String day=CmmUtil.nvl(food_day.next().text()).trim().toString();

         pDTO.setDay(day.substring(3,day.length()));
